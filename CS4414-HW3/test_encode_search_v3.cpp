...
int main() {
    ...
    // Warm-up with 5 queries
    std::cout << "Warming up with 5 queries..." << std::endl;
    for (int w = 0; w < 5; ++w) {
    ...
    std::cout << "Running queries 5-24 (encode + search only):\n";
